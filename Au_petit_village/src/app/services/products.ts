...
export class ProductsService {
  private products: Product[] = [
    ...
    {
      id: 3,
      name: 'Astérix pile d\'albums',
      price: 32.99,
      image: 'figurine-asterix-pile-d-albums-2nde-edition.webp',
      description: "Astérix est debout, à côté d'une pile d'albums, et lit l'une d'entre elles. Idéfix est assis sur la pile et regarde Astérix. Astérix lit : 'Astérix chez les Bretons'. ",
    ...
    },
    {
      ...
      name: 'Astérix énervé',
      price: 30.99,
      image: 'figurine-asterix-bulle-ca-m-enerve.webp',
    ...
    },
    {
      ...
      name: 'Obélix boudeur',
      price: 33.99,
      image: 'figurine-obelix-boude.webp',
    ...
    },
    {
      ...
      name: 'Panoramix',
      price: 39.99,
      image: 'figurine-panoramix-bulle.webp',
